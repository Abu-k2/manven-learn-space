      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className="bg-card p-8 rounded-lg shadow-card hover:shadow-hero transition-all duration-300 hover:-translate-y-1 border border-border animate-fade-in"
            >
              <div className="mb-4">
                <svg className="w-8 h-8 text-hero-secondary" fill="currentColor" viewBox="0 0 20 20">
